#ifndef __ARM_PAGESIZE_H__
#define __ARM_PAGESIZE_H__
 ...
 */
#define COYOTOS_ARM_PAGE_SIZE		0x1000
/** @brief Number of page offset bits. */
#define COYOTOS_ARM_PAGE_ADDR_BITS	12
...
#define COYOTOS_ARM_PAGE_ADDR_MASK	0xfff

/** @brief Number of virtual address bits supported for this
    target. */
#define COYOTOS_ARM_ADDRESS_BITS	32

#if (COYOTOS_TARGET == COYOTOS_TARGET_arm)

#define COYOTOS_PAGE_SIZE       COYOTOS_ARM_PAGE_SIZE
#define COYOTOS_PAGE_ADDR_BITS  COYOTOS_ARM_PAGE_ADDR_BITS
#define COYOTOS_PAGE_ADDR_MASK  COYOTOS_ARM_PAGE_ADDR_MASK
#define COYOTOS_HW_ADDRESS_BITS COYOTOS_ARM_ADDRESS_BITS

#endif

#endif /* __ARM_PAGESIZE_H__ */
