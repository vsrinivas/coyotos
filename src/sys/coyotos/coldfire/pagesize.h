#ifndef __COLDFIRE_PAGESIZE_H__
 ...
 * supported by the target hardware architecture, and that this is
 * actually the case for the Coldfire target.
 */
#define COYOTOS_COLDFIRE_PAGE_SIZE	0x2000
/** @brief Number of page offset bits. */
#define COYOTOS_COLDFIRE_PAGE_ADDR_BITS	13
...
#define COYOTOS_COLDFIRE_PAGE_ADDR_MASK	0x1fff

/** @brief Number of virtual address bits supported for this
    target. */
#define COYOTOS_COLDFIRE_ADDRESS_BITS	32

#if (COYOTOS_ARCH == COYOTOS_ARCH_coldfire)

#define COYOTOS_PAGE_SIZE       COYOTOS_COLDFIRE_PAGE_SIZE
#define COYOTOS_PAGE_ADDR_BITS  COYOTOS_COLDFIRE_PAGE_ADDR_BITS
#define COYOTOS_PAGE_ADDR_MASK  COYOTOS_COLDFIRE_PAGE_ADDR_MASK
#define COYOTOS_HW_ADDRESS_BITS COYOTOS_COLDFIRE_ADDRESS_BITS

#endif

#endif /* __COLDFIRE_PAGESIZE_H__ */
